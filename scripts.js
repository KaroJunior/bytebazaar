...
//Animation
// Select all sections with the class 'animate-section'
...
const intersectionCallback = (entries, observer) => {
    entries.forEach(entry => {
        // If the section is intersecting (i.e., visible in the viewport)
        if (entry.isIntersecting) {
            entry.target.classList.add('visible'); // Add a class to start the animation
